...
export const content: ToolLocaleContent<AcTonnageCalculatorUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: "Этот раздел дополняет рекомендации для сравнения сценариев и понимания результата. 7.",
    },
    {
      type: 'paragraph',
      html: "Этот раздел дополняет рекомендации для сравнения сценариев и понимания результата. 8.",
    },
    {
      type: 'paragraph',
      html: "Этот раздел дополняет рекомендации для сравнения сценариев и понимания результата. 9.",
    },
  ],
  ui: {
