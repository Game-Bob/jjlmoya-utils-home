...
export const content: ToolLocaleContent<WifiRangeSimulatorUI> = {
  ...
  ui: {
    ...
    tipFishTank: 'Een aquarium blokkeert wifi als een betonnen muur. Verplaats de router of het apparaat ervan weg.',
    tipMicrowave: 'Magnetrons verstoren de 2,4 GHz-band tijdens gebruik. Gebruik 5 GHz of plaats de router verder van de keuken.',
    labelMove: 'Verplaatsen',
    labelWalls: 'Muren',
    labelDrywall: 'Gipsplaat',
    labelBrick: 'Baksteen',
    labelConcrete: 'Beton',
    labelStone: 'Steen',
    labelObjects: 'Objecten',
    labelWood: 'Hout',
    labelMetal: 'Metaal',
    labelWindow: 'Raam',
    labelFridge: 'Koelkast',
    labelFish: 'Vis',
    labelMicro: 'Micro',
    labelMirror: 'Spiegel',
    labelFurn: 'Meubel',
    ...
    labelAddDevice: '+ Apparaat',
    labelClearWalls: 'Muren wissen',
    labelClearObjects: 'Objecten wissen',
    labelClearAll: 'Alles wissen',
    labelZoomIn: 'Inzoomen',
    labelZoomOut: 'Uitzoomen',
    labelRouter: 'Router',
    labelAverageSignal: 'Gemiddeld signaal',
    labelScaleMeters: '5 m',
    hintText: 'Sleep router of apparaten om ze te verplaatsen. Dubbelklik op muren of objecten om ze te verwijderen. Ctrl+Z om ongedaan te maken.',
    labelMaxDevices: 'Max 4 apparaten',
    labelDevicePrefix: 'Apparaat',
    labelPerDevice: 'Per apparaat',
    labelDb: 'dB',
  },
};
