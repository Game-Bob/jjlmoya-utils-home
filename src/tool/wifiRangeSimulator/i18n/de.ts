...
export const content: ToolLocaleContent<WifiRangeSimulatorUI> = {
  ...
  ui: {
    ...
    tipFishTank: 'Ein Aquarium blockiert WLAN wie eine Betonwand. Bewegen Sie den Router oder das Gerät davon weg.',
    tipMicrowave: 'Mikrowellen stören das 2,4-GHz-Band beim Betrieb. Nutzen Sie 5 GHz oder stellen Sie den Router weiter von der Küche entfernt auf.',
    labelMove: 'Bewegen',
    labelWalls: 'Wände',
    labelDrywall: 'Trockenbau',
    labelBrick: 'Ziegel',
    labelConcrete: 'Beton',
    labelStone: 'Stein',
    ...
    labelAddDevice: '+ Gerät',
    labelClearWalls: 'Wände löschen',
    labelClearObjects: 'Objekte löschen',
    labelClearAll: 'Alles löschen',
    labelZoomIn: 'Vergrößern',
    labelZoomOut: 'Verkleinern',
    labelRouter: 'Router',
    labelAverageSignal: 'Durchschnittssignal',
    labelScaleMeters: '5 m',
    hintText: 'Router oder Geräte zum Bewegen ziehen. Doppelklicken Sie auf Wände oder Objekte, um sie zu löschen. Strg+Z zum Rückgängig machen.',
    labelMaxDevices: 'Max. 4 Geräte',
    labelDevicePrefix: 'Gerät',
    labelPerDevice: 'Pro Gerät',
    labelDb: 'dB',
  },
};
