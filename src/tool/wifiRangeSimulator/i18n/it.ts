...
export const content: ToolLocaleContent<WifiRangeSimulatorUI> = {
  ...
  ui: {
    ...
    tipFishTank: 'Un acquario blocca il WiFi come un muro di cemento. Allontana il router o il dispositivo.',
    tipMicrowave: 'I microonde disturbano la banda 2,4 GHz quando sono accesi. Usa 5 GHz o allontana il router dalla cucina.',
    labelMove: 'Sposta',
    labelWalls: 'Muri',
    labelDrywall: 'Cartongesso',
    labelBrick: 'Mattone',
    labelConcrete: 'Cemento',
    labelStone: 'Pietra',
    labelObjects: 'Oggetti',
    labelWood: 'Legno',
    labelMetal: 'Metallo',
    labelWindow: 'Finestra',
    labelFridge: 'Frigo',
    labelFish: 'Pesce',
    labelMicro: 'Micro',
    labelMirror: 'Specchio',
    labelFurn: 'Arredo',
    labelActions: 'Azioni',
    labelUndo: 'Annulla',
    labelAddDevice: '+ Dispositivo',
    labelClearWalls: 'Cancella muri',
    labelClearObjects: 'Cancella oggetti',
    labelClearAll: 'Cancella tutto',
    labelZoomIn: 'Ingrandisci',
    labelZoomOut: 'Rimpicciolisci',
    labelRouter: 'Router',
    labelAverageSignal: 'Segnale medio',
    labelScaleMeters: '5 m',
    hintText: 'Trascina il router o i dispositivi per spostarli. Doppio clic su muri o oggetti per eliminarli. Ctrl+Z per annullare.',
    labelMaxDevices: 'Max 4 dispositivi',
    labelDevicePrefix: 'Dispositivo',
    labelPerDevice: 'Per dispositivo',
    labelDb: 'dB',
  },
};
