...
export const content: ToolLocaleContent<WifiRangeSimulatorUI> = {
  ...
  ui: {
    ...
    tipFishTank: 'Akwarium blokuje Wi-Fi jak betonowa ściana. Odsuń router lub urządzenie od niego.',
    tipMicrowave: 'Mikrofalówki zakłócają pasmo 2,4 GHz podczas pracy. Użyj 5 GHz lub odsuń router od kuchni.',
    labelMove: 'Przesuń',
    labelWalls: 'Ściany',
    labelDrywall: 'Gips',
    labelBrick: 'Cegła',
    ...
    labelActions: 'Akcje',
    labelUndo: 'Cofnij',
    labelAddDevice: '+ Urządzenie',
    labelClearWalls: 'Wyczyść ściany',
    labelClearObjects: 'Wyczyść obiekty',
    labelClearAll: 'Wyczyść wszystko',
    labelZoomIn: 'Przybliż',
    labelZoomOut: 'Oddal',
    labelRouter: 'Router',
    labelAverageSignal: 'Średni sygnał',
    labelScaleMeters: '5 m',
    hintText: 'Przeciągnij router lub urządzenia, aby je przesunąć. Kliknij dwukrotnie ściany lub obiekty, aby usunąć. Ctrl+Z, aby cofnąć.',
    labelMaxDevices: 'Maks. 4 urządzenia',
    labelDevicePrefix: 'Urządzenie',
    labelPerDevice: 'Na urządzenie',
    labelDb: 'dB',
  },
};
