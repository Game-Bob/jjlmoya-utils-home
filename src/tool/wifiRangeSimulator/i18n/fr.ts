...
export const content: ToolLocaleContent<WifiRangeSimulatorUI> = {
  ...
  ui: {
    ...
    tipFishTank: 'Un aquarium bloque le WiFi comme un mur en béton. Éloignez le routeur ou l\'appareil.',
    tipMicrowave: 'Les micro-ondes brouillent la bande 2,4 GHz en fonctionnement. Utilisez le 5 GHz ou éloignez le routeur de la cuisine.',
    labelMove: 'Déplacer',
    labelWalls: 'Murs',
    labelDrywall: 'Plâtre',
    labelBrick: 'Brique',
    ...
    labelUndo: 'Annuler',
    labelAddDevice: '+ Appareil',
    labelClearWalls: 'Effacer murs',
    labelClearObjects: 'Effacer objets',
    labelClearAll: 'Tout effacer',
    labelZoomIn: 'Zoom avant',
    labelZoomOut: 'Zoom arrière',
    labelRouter: 'Routeur',
    labelAverageSignal: 'Signal moyen',
    labelScaleMeters: '5 m',
    hintText: 'Faites glisser le routeur ou les appareils pour les déplacer. Double-cliquez sur les murs ou objets pour les supprimer. Ctrl+Z pour annuler.',
    labelMaxDevices: 'Max 4 appareils',
    labelDevicePrefix: 'Appareil',
    labelPerDevice: 'Par appareil',
    labelDb: 'dB',
  },
};
