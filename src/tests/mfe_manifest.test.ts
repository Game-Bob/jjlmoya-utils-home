...
describe("MFE utility manifest", () => {
    it("returns a versioned installable manifest for the current utility", async () => {
        const response = createUtilityManifestResponse({
            ...
            startUrl: "/en/utilities/categories/home/card-draw-odds-calculator/",
        ...
        expect(manifest.icons[0]?.src).toContain("/_utilities/home/images/card-draw-odds-calculator.webp?version=");
