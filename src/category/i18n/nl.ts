...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Waarom berekenen voordat u beslissingen over uw huis neemt?',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'De meeste beslissingen in huis worden genomen op basis van een onderbuikgevoel: "Ik denk dat deze zonnepanelen wel genoeg zullen zijn", "het vervangen van die lampen zal wel wat besparen". De realiteit is dat een berekening van vijf minuten u honderden euro\'s per jaar kan besparen of u een dure renovatie kan besparen. Onze tools zijn gebaseerd op <strong>echte natuurkunde</strong>: zonnestraling per breedtegraad, gemeten verbruik in watt, psychrometrie van vochtige lucht en projectieoptiek.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Zonne-energie voor woningen: verder dan de marketing',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'De optimale oriëntatie en helling van een zonnepaneel variëren met de breedtegraad. In continentaal Europa ligt de ideale hoek tussen de 30° en 40°, afhankelijk van het seizoen. Optimaliseren voor de totale jaaropbrengst is niet hetzelfde als optimaliseren voor de wintermaanden, wanneer de vraag naar elektriciteit het hoogst is.',
    },
    {
      type: 'title',
      text: 'Echte energiebesparing: led-lampen en energietarieven',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Overstappen van halogeen naar led is niet simpelweg "minder watt gebruiken". Het betekent begrijpen dat een led-lamp van 9 W een halogeenlamp van 60 W vervangt terwijl deze dezelfde lichtstroom (800 lumen) levert, wat een <strong>verbruiksreductie van 85%</strong> oplevert. Vermenigvuldigd met de jaarlijkse gebruiksuren en de prijs per kWh kan de besparing tot op de cent nauwkeurig worden gekwantificeerd. Onze calculator doet precies dat.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Vochtigheid en condensatie: het stille probleem',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Door het dauwpunt van uw omgeving te kennen, kunt u handelen voordat er schimmel verschijnt: ventileer op het juiste moment, pas de verwarming aan of identificeer koude plekken in huis waar condensatie onvermijdelijk is zonder extra isolatie.',
    },
    {
      type: 'title',
      text: 'Audiovisuele installaties: de projectieafstand berekenen',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Onze projectorcalculator geeft u de exacte afstand op basis van de projectieverhouding van uw model, de gewenste schermgrootte en de beeldverhouding (16:9, 4:3, 2.35:1). Ideaal voor het plannen van de installatie voordat u gaten in de muur boort of de beugel koopt.',
    },
    {
      type: 'title',
      text: 'Connectiviteit en digitale hulpmiddelen voor het moderne huis',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Het efficiënte huis: een investering met meetbaar rendement',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Deze tools zijn voortgekomen uit de behoefte om thuis beslissingen te nemen met dezelfde nauwkeurigheid als in een professionele omgeving. De fysica van een woning verschilt niet van die van de industrie: dezelfde wetten, dezelfde formules, hetzelfde potentieel voor optimalisatie. Het verschil is het hebben van toegang tot de berekeningen.',
    },
  ],
};
