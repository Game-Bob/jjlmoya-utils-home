...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Mengapa berhitung sebelum membuat keputusan rumah tangga?',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Sebagian besar keputusan rumah tangga dibuat berdasarkan perasaan: "Saya rasa panel surya ini sudah cukup", "mengganti lampu seharusnya bisa menghemat sesuatu". Faktanya, perhitungan lima menit dapat menghemat ratusan euro per tahun atau menghindarkan Anda dari renovasi yang mahal. Alat kami didasarkan pada <strong>fisika nyata</strong>: radiasi surya berdasarkan lintang, konsumsi daya yang diukur, psikrometri udara lembap, optik proyeksi.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Energi surya residensial: melampaui sekadar pemasaran',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Orientasi dan kemiringan optimal panel surya bervariasi sesuai lintang. Di Eropa daratan, sudut ideal berkisar antara 30° hingga 40° tergantung pada musim. Mengoptimalkan untuk total output tahunan tidaklah sama dengan mengoptimalkan untuk bulan-bulan musim dingin, saat permintaan listrik paling tinggi.',
    },
    {
      type: 'title',
      text: 'Penghematan energi nyata: lampu LED dan tarif listrik',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Beralih dari halogen ke LED bukan sekadar "menggunakan watt yang lebih sedikit". Ini berarti memahami bahwa LED 9 W menggantikan halogen 60 W sambil memberikan fluks cahaya yang sama (800 lumen), mencapai <strong>pengurangan konsumsi sebesar 85%</strong>. Dikalikan dengan jam penggunaan tahunan dan harga per kWh, penghematan dapat dikuantifikasi hingga sen terkecil. Kalkulator kami melakukan hal tersebut dengan tepat.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Kelembapan dan kondensasi: masalah tersembunyi',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Mengetahui titik embun di lingkungan Anda memungkinkan Anda bertindak sebelum jamur muncul: ventilasi di saat yang tepat, sesuaikan pemanas, atau identifikasi titik-titik dingin di rumah di mana kondensasi tidak terhindarkan tanpa isolasi tambahan.',
    },
    {
      type: 'title',
      text: 'Instalasi audio visual: menghitung jarak proyeksi',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Kalkulator proyektor kami memberikan jarak yang tepat berdasarkan rasio tembak model Anda, target ukuran layar, dan rasio gambar (16:9, 4:3, 2.35:1). Ideal untuk merencanakan instalasi sebelum mengebor dinding atau membeli braket.',
    },
    {
      type: 'title',
      text: 'Konektivitas dan utilitas digital untuk rumah modern',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Rumah yang efisien: investasi dengan hasil terukur',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Alat-alat ini dibuat dari kebutuhan untuk membuat keputusan rumah tangga dengan ketelitian yang sama dengan keputusan profesional. Fisika di rumah tidak berbeda dengan fisika di industri: hukum yang sama, formula yang sama, potensi optimasi yang sama. Perbedaannya adalah memiliki akses ke perhitungannya.',
    },
  ],
};
