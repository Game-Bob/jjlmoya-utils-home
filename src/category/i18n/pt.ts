...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Porquê calcular antes de tomar decisões para a casa?',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'A maioria das decisões domésticas é tomada por instinto: "Acho que estes painéis solares serão suficientes", "trocar as lâmpadas deve poupar alguma coisa". A verdade é que um cálculo de cinco minutos pode poupar-lhe centenas de euros por ano ou evitar-lhe uma renovação dispendiosa. As nossas ferramentas baseiam-se em <strong>física real</strong>: irradiação solar por latitude, consumo medido em watts, psicrometria do ar húmido, ótica de projeção.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Energia solar residencial: para além do marketing',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'A orientação e inclinação ideais de um painel solar variam com a latitude. Na Europa continental, o ângulo ideal varia entre 30° e 40° dependendo da estação. Otimizar para a produção anual total não é o mesmo que otimizar para os meses de inverno, quando a procura de eletricidade é maior.',
    },
    {
      type: 'title',
      text: 'Poupança de energia real: lâmpadas LED e tarifas de eletricidade',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Mudar de halogéneo para LED não é apenas "usar menos watts". Significa compreender que um LED de 9 W substitui um halogéneo de 60 W enquanto fornece o mesmo fluxo luminoso (800 lúmenes), alcançando uma <strong>redução de 85% no consumo</strong>. Multiplicado pelas horas anuais de utilização e pelo preço por kWh, a poupança pode ser quantificada ao cêntimo. A nossa calculadora faz exatamente isso.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Humidade e condensação: o problema silencioso',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Conhecer o ponto de orvalho do seu ambiente permite-lhe agir antes de o bolor aparecer: ventilar no momento certo, ajustar o aquecimento ou identificar pontos frios na casa onde a condensação é inevitável sem isolamento adicional.',
    },
    {
      type: 'title',
      text: 'Instalações audiovisuais: calcular a distância de projeção',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'A nossa calculadora de projetor indica-lhe a distância exata com base no rácio de projeção do seu modelo, no tamanho de ecrã pretendido e no formato da imagem (16:9, 4:3, 2.35:1). Ideal para planear a instalação antes de furar paredes ou comprar o suporte.',
    },
    {
      type: 'title',
      text: 'Conectividade e utilitários digitais para a casa moderna',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'A casa eficiente: um investimento com retorno mensurável',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Estas ferramentas foram criadas a partir da necessidade de tomar decisões domésticas com o mesmo rigor aplicado às decisões profissionais. A física de uma casa não é diferente daquela de uma indústria: mesmas leis, mesmas fórmulas, mesmo potencial de otimização. A diferença é ter acesso aos cálculos.',
    },
  ],
};
