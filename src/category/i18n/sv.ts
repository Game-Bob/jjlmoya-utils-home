...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Varför räkna innan du fattar beslut om hemmet?',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'De flesta beslut i hemmet fattas på magkänsla: "Jag tror att dessa solpaneler räcker", "att byta glödlampor borde spara något". Sanningen är att en femminuters beräkning kan spara dig hundratals euro per år eller bespara dig en dyr renovering. Våra verktyg är baserade på <strong>verklig fysik</strong>: solinstrålning per breddgrad, uppmätt wattförbrukning, fuktig lufts psykrometri och projektionsoptik.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Solenergi för bostäder: bortom marknadsföringen',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Den optimala orienteringen och lutningen på en solpanel varierar med breddgrad. I kontinentala Europa ligger den ideala vinkeln mellan 30° och 40° beroende på säsong. Att optimera för total årlig produktion är inte samma sak som att optimera för vintermånaderna, då elbehovet är som störst.',
    },
    {
      type: 'title',
      text: 'Verklig energibesparing: LED-lampor och eltariffer',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Att byta från halogen till LED handlar inte bara om att "använda färre watt". Det innebär att förstå att en 9 W LED ersätter en 60 W halogen samtidigt som den levererar samma ljusflöde (800 lumen), vilket ger en <strong>minskning av förbrukningen med 85 %</strong>. Multiplicerat med årliga drifttimmar och pris per kWh kan besparingen kvantifieras ner till öret. Vår kalkylator gör exakt det.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Fukt och kondens: det tysta problemet',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Att känna till daggpunkten i din miljö gör att du kan agera innan mögel uppstår: ventilera vid rätt tillfälle, justera uppvärmningen eller identifiera kalla punkter i hemmet där kondens är oundviklig utan ytterligare isolering.',
    },
    {
      type: 'title',
      text: 'Audiovisuella installationer: beräkna projektionsavstånd',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Vår projektorkalkylator ger dig det exakta avståndet baserat på din modells projektionsförhållande, den önskade skärmstorleken och bildformatet (16:9, 4:3, 2.35:1). Idealiskt för att planera installationen innan du borrar i väggar eller köper fästet.',
    },
    {
      type: 'title',
      text: 'Anslutning och digitala verktyg för det moderna hemmet',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Det effektiva hemmet: en investering med mätbar avkastning',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Dessa verktyg skapades utifrån behovet av att fatta beslut i hemmet med samma stringens som tillämpas på professionella beslut. Fysiken i ett hem skiljer sig inte från industrins: samma lagar, samma formler, samma potential för optimering. Skillnaden är att ha tillgång till beräkningarna.',
    },
  ],
};
