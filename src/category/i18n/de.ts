...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Warum rechnen, bevor man Entscheidungen für das Zuhause trifft?',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Solarenergie für Wohngebäude: jenseits des Marketings',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Die optimale Ausrichtung und Neigung eines Solarmoduls variieren je nach Breitengrad. In Mitteleuropa liegt der ideale Winkel je nach Jahreszeit zwischen 30° und 40°. Die Optimierung auf den gesamten Jahresertrag ist nicht dasselbe wie die Optimierung für die Wintermonate, in denen der Strombedarf am höchsten ist.',
    },
    {
      type: 'title',
      text: 'Echte Energieeinsparungen: LED-Leuchtmittel und Stromtarife',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Feuchtigkeit und Kondensation: das stille Problem',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Die Kenntnis des Taupunkts Ihrer Umgebung ermöglicht es Ihnen zu handeln, bevor Schimmel auftritt: Richtig lüften, Heizung anpassen oder Kältebrücken im Haus identifizieren, an denen Kondensation ohne zusätzliche Isolierung unvermeidlich ist.',
    },
    {
      type: 'title',
      text: 'Audiovisuelle Installationen: Berechnung des Projektionsabstands',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Unser Projektorrechner liefert Ihnen die exakte Entfernung basierend auf dem Projektionsverhältnis Ihres Modells, der Zielbildgröße und dem Bildformat (16:9, 4:3, 2,35:1). Ideal für die Planung der Installation, bevor Sie Löcher in die Wand bohren oder die Halterung kaufen.',
    },
    {
      type: 'title',
      text: 'Konnektivität und digitale Hilfsmittel für das moderne Zuhause',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Das effiziente Haus: eine Investition mit messbarer Rendite',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Diese Tools wurden aus dem Bedürfnis heraus entwickelt, Entscheidungen zu Hause mit der gleichen Strenge zu treffen wie im professionellen Bereich. Die Physik eines Zuhauses unterscheidet sich nicht von der in der Industrie: dieselben Gesetze, dieselben Formeln, dasselbe Optimierungspotenzial. Der Unterschied besteht darin, Zugang zu den Berechnungen zu haben.',
    },
  ],
};
