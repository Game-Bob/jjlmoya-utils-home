...
export const content: CategoryLocaleContent = {
  slug: 'home',
  title: 'Home Calculators and Utilities',
  description: 'Optimize your home with real data. Free tools to calculate energy savings, compare electricity tariffs, size solar panels, prevent condensation, and plan your audiovisual setup.',
  seo: [
    {
      type: 'title',
      text: 'Why calculate before making home decisions?',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Most home decisions are made on gut feeling: "I think these solar panels will be enough", "switching bulbs should save something". The truth is that a five-minute calculation can save you hundreds of euros a year or spare you an expensive renovation. Our tools are based on <strong>real physics</strong>: solar irradiation by latitude, measured wattage consumption, moist air psychrometry, projection optics.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Residential solar energy: beyond the marketing',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'The optimal orientation and tilt of a solar panel vary with latitude. In continental Europe, the ideal angle ranges between 30° and 40° depending on the season. Optimising for total annual output is not the same as optimising for winter months, when electricity demand is highest.',
    },
    {
      type: 'title',
      text: 'Real energy savings: LED bulbs and electricity tariffs',
      level: 2,
    },
    {
      type: 'paragraph',
      html: 'Switching from halogens to LED is not simply "using fewer watts". It means understanding that a 9 W LED replaces a 60 W halogen while delivering the same luminous flux (800 lumens), achieving an <strong>85% reduction in consumption</strong>. Multiplied by annual hours of use and the price per kWh, savings can be quantified to the cent. Our calculator does exactly that.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Humidity and condensation: the silent problem',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Knowing the dew point of your environment lets you act before mould appears: ventilate at the right moment, adjust heating, or identify cold spots in the home where condensation is inevitable without additional insulation.',
    },
    {
      type: 'title',
      text: 'Audiovisual installations: calculating throw distance',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Our projector calculator gives you the exact distance based on your model\'s throw ratio, the target screen size, and the image ratio (16:9, 4:3, 2.35:1). Ideal for planning the installation before drilling walls or purchasing the mount.',
    },
    {
      type: 'title',
      text: 'Connectivity and digital utilities for the modern home',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'The efficient home: an investment with measurable returns',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'These tools were built from the need to make home decisions with the same rigour applied to professional ones. The physics of a home are no different from those of industry: same laws, same formulas, same potential for optimisation. The difference is having access to the calculations.',
    },
  ],
};
