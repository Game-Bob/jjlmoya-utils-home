...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Dlaczego warto liczyć przed podjęciem decyzji dotyczących domu?',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Energia słoneczna w domu: więcej niż marketing',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Optymalna orientacja i nachylenie panelu słonecznego zmieniają się wraz z szerokością geograficzną. W Europie środkowej idealny kąt wynosi od 30° do 40° w zależności od pory roku. Optymalizacja pod kątem całkowitej rocznej produkcji to nie to samo, co optymalizacja pod kątem miesięcy zimowych, gdy zapotrzebowanie na energię jest największe.',
    },
    {
      type: 'title',
      text: 'Prawdziwe oszczędności: żarówki LED i taryfy prądu',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Wilgoć i kondensacja: cichy problem',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Znajomość punktu rosy w Twoim otoczeniu pozwala działać, zanim pojawi się pleśń: wietrzyć w odpowiednim momencie, wyregulować ogrzewanie lub zidentyfikować zimne miejsca w domu, gdzie bez dodatkowej izolacji kondensacja jest nieunikniona.',
    },
    {
      type: 'title',
      text: 'Instalacje audiowizualne: obliczanie odległości rzutu',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Nasz kalkulator projektora poda Ci dokładną odległość na podstawie współczynnika rzutu Twojego modelu, docelowego rozmiaru ekranu i proporcji obrazu (16:9, 4:3, 2.35:1). Idealne rozwiązanie do zaplanowania instalacji przed wierceniem w ścianach czy zakupem uchwytu.',
    },
    {
      type: 'title',
      text: 'Łączność i cyfrowe narzędzia dla nowoczesnego domu',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'title',
      text: 'Efektywny dom: inwestycja o mierzalnym zwrocie',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'Narzędzia te powstały z potrzeby podejmowania domowych decyzji z taką samą rzetelnością, jaka cechuje te profesjonalne. Fizyka domu nie różni się od fizyki przemysłowej: te same prawa, te same wzory, ten sam potencjał optymalizacji. Różnica polega na dostępie do obliczeń.',
    },
  ],
};
