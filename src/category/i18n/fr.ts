...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Pourquoi calculer avant d\'agir à la maison ?',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: 'L\'orientation et l\'inclinaison optimales d\'un panneau solaire varient selon la latitude. En Europe continentale, l\'angle idéal se situe entre 30° et 40° selon la saison. Optimiser pour la production annuelle totale n\'est pas la même chose qu\'optimiser pour les mois d\'hiver, quand la demande électrique est la plus forte.',
    },
    {
      type: 'title',
    ...
    {
      type: 'paragraph',
      html: 'Passer des halogènes aux LED, ce n\'est pas simplement "utiliser moins de watts". C\'est comprendre qu\'une ampoule LED de 9 W remplace un halogène de 60 W en produisant le même flux lumineux (800 lumens), avec une <strong>réduction de 85 % de la consommation</strong>. Multiplié par les heures d\'utilisation annuelles et le prix du kWh, l\'économie se calcule au centime. Notre calculateur fait exactement cela.',
    },
    {
      type: 'paragraph',
      html: 'Bien choisir son tarif électrique est tout aussi important. Les offres à prix fixe peuvent être avantageuses pour les consommateurs aux habitudes régulières ; les tarifs indexés fluctuent avec le marché de gros et récompensent ceux qui décalent leur consommation aux heures creuses. Comparer les deux options avec vos données réelles de consommation peut représenter une différence de <strong>100 à 300 € par an</strong>.',
    },
    {
      type: 'title',
    ...
    {
      type: 'paragraph',
      html: 'Notre calculateur de projecteur vous donne la distance exacte selon le throw ratio de votre modèle, la taille d\'écran cible et le format d\'image (16:9, 4:3, 2.35:1). Idéal pour planifier l\'installation avant de percer les murs ou d\'acheter le support.',
    },
    {
      type: 'title',
      text: 'Connectivité et outils numériques pour la maison moderne',
      level: 2,
    },
    {
      type: 'paragraph',
