...
const UTILITY_ASSET_ROOT = "/_utilities/home";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/home/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/home/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("home");
